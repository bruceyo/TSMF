...
from feeder import segment_rgbbody_5fs_ntu as rgb_roi
...
class Feeder(torch.utils.data.Dataset):
    ...
    def __init__(self,
        ...
        self.rgb_path = '/media/bruce/2Tssd/data/ntu_rgb_frames_crop/fivefs/'
        self.load_data(mmap)
    ...
    def __getitem__(self, index):
        ...
        if self.evaluation:
            rgb = self.sample_name[index][0:20] + '.png'
            rgb = Image.open(self.rgb_path + rgb)
        else:
            rgb = rgb_roi.construct_st_roi(self.sample_name[index][0:20], self.evaluation, self.random_interval,self.random_roi_move,self.random_flip)
